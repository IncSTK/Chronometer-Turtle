...
function Chronometer:PaladinSetup()
	...
	self:AddTimer(self.SPELL, BS["Blessing of Kings"],     600, 1,1,1, { gr=1, rc=true })
	self:AddTimer(self.SPELL, BS["Blessing of Light"],     600, 1,1,1, { gr=1, rc=true })
	self:AddTimer(self.SPELL, BS["Blessing of Might"],     600, 1,1,1, { gr=1, rc=true })
	...
	self:AddTimer(self.SPELL, BS["Blessing of Salvation"], 600, 1,1,1, { gr=1, rc=true })
	self:AddTimer(self.SPELL, BS["Blessing of Sanctuary"], 600, 1,1,1, { gr=1, rc=true })
	self:AddTimer(self.SPELL, BS["Blessing of Wisdom"],    600, 1,1,1, { gr=1, rc=true })
